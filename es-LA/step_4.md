...
Usa una manzana diferente para probar el modelo.
...
Sostén una manzana **roja** frente a la cámara web para probar el modelo.

El modelo **no** debería realizar una predicción con una alta puntuación de fiabilidad de que es una manzana.

¡Es probable que prediga que es un **tomate**!
