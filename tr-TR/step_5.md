...
Eğitim verileri yalnızca yeşil elmaları içerdiğinden yanlıdır.
...
**Kırmızı** elmanıza en çok benzeyen görselleri seçin.

**İpucu:** Kırmızı elmanızın fotoğraflarını çekmek için web kameranızı da kullanabilirsiniz.
...
Model, bunun bir **domates** olduğuna dair **daha düşük bir güven puanına** sahip bir tahmin üretebilir.
